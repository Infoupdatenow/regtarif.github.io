...
<div class="inpalxbrm">
<p>Login</p>
<form method="post" action="auth/send_login.php">
...
<button style="width:60px; margin-left:10px" class="button"><img width="32px" style="margin:-15px;" src="https://cdn.icon-icons.com/icons2/2622/PNG/512/gui_fingerprint_icon_157660.png"></button>
</div>
</div>
</frmalxbr>
